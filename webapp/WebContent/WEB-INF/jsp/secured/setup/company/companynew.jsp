...
<spring:url var="saveUrl" value="/secured/setup/company/new" />
<spring:url var="gridUrl" value="/secured/setup/company/usergridnew" />
...
function checkbox(cellvalue, options, rowObject) {
	return '<input type="checkbox" name="newUser" value="' + rowObject.id + '" />'; 
}
		...
		<div class="col-sm-1"></div>
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<spring:message code="setup.company.newCompany" />
				</div>
						...
						<div class="tab-content">
							...
							<div id="tab-CompanyProfile" class="tab-pane fade in active panel-body">
								<div class="form-group row">
									...
									<span class="col-sm-4">
										<form:input path="company.code" class="form-control input-sm" id="code" style="width:100%; text-transform: uppercase"/>
									</span>
							...
							<div id="tab-UserCompany" class="tab-pane fade panel-body">
								...
								<datatables:table id="usergrid" cssClass="table table-striped" url="${gridUrl}" pageable="false" filterable="false"
