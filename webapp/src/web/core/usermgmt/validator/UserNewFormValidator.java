...
public class UserNewFormValidator implements Validator {

	private UserMgmtService userMgmtService;

	public UserNewFormValidator(UserMgmtService userMgmtService) {
	...
	public void validate(Object obj, Errors errors) {
		...
		ValidationUtils.rejectIfEmpty(errors, "user.password", "usermgmt.user.required.password");
		...
		if (userMgmtService.getUserByUsername(form.getUser().getUsername()) != null) {
			errors.reject("usermgmt.user.username_exists");
		}
